...
## 6. 기대효과
반려견의 산책은 반려견의 건강 관리를 위해 필수 루틴이다. 이 서비스는 산책 코스를 고민해야 하는 수고를 덜어주고, 원하는 산책 시간이나 강도에 따라 맞춤 코스를 선택할 수 있도록 하여 선택의 폭을 넓혀준다. 산책 중간에 반려견의 미용을 위한 미용샵이나 사료 및 간식 구입, 반려견 동반 입장 가능 카페 등의 정보를 제공 받고 싶은 경우, 일일이 찾아볼 필요 없이 Map API를 통한 서비스를 제공하여 간편하게 한 번에 확인하고 이용할 수 있도록 한다.
